define([
    ...
    var TabulatorN3Parser = function () {
        ...
        if (typeof N3Parser.Util.uri == "undefined") {
            N3Parser.Util.uri = {};
        }
        ...
        N3Parser.Graph = function (){
            return new N3Parser.IndexedFormula(undefined, N3Parser.graph);
        };
        // ends
        ...
        N3Parser.IndexedFormula = function () {
            ...
            N3Parser.IndexedFormula = function (features, graph) {
            ...
            N3Parser.IndexedFormula.prototype = Dictionary.Formula(N3Parser.graph);
            N3Parser.IndexedFormula.prototype.constructor = N3Parser.IndexedFormula;
            //N3Parser.IndexedFormula.SuperClass = Dictionary.Formula;
            ...
            N3Parser.IndexedFormula.prototype.add = function (subj, pred, obj, why) {
                var actions, st;
                if (why == undefined) why = this.fetcher ? this.fetcher.appNode: Dictionary.Symbol("chrome:theSession"); //system generated
                ...
                var st = Dictionary.Statement(subj, pred, obj, why, this.graph);
            ...
            N3Parser.IndexedFormula.prototype.formula = function (features) {
                return new N3Parser.IndexedFormula(features, this.graph);
            }
